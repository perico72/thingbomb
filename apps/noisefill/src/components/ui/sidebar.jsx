  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            `relative w-[--sidebar-width] bg-transparent transition-[width] duration-150
            ease-linear`,
        ...
        <div
          className={cn(
            ...
            transition-[left,right,width] duration-150 ease-linear md:flex`,
            side === "left"
  ...
  return (
    <main
      ...
      className={cn(
        ...
        md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-md
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          transition-[margin,opacity] duration-150 ease-linear focus-visible:ring-2
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          transition-transform hover:bg-sidebar-accent
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4
          [&>svg]:shrink-0`,
          // Increases the hit area of the button on mobile.
          "after:absolute after:-inset-2 after:md:hidden",
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          px-2 text-sidebar-foreground outline-none ring-sidebar-ring
